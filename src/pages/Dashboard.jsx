            ...
            <div className="dashboard-content">
                <div className="dashboard-title-bar">
                    <div>
                        ...
                        <p className="dashboard-subtitle">Plan and manage your travel itineraries</p>
                    </div>
                    <Button
                        type="primary"
                        icon={<PlusOutlined />}
                ...
                {trips.length === 0 ? (
                    <Empty
                        ...
                        style={{ marginTop: 60 }}
                    >
                        <Button type="primary" icon={<PlusOutlined />} onClick={handleNewTrip}>
                            ...
                            <Card
                                ...
                                actions={[
                                    <Button
                                        type="text"
                                        icon={<EditOutlined />}
                                        onClick={(e) => { e.stopPropagation(); handleEditTrip(trip.id); }}
                                    >
                                        Edit
                                    </Button>,
                                    <Button
